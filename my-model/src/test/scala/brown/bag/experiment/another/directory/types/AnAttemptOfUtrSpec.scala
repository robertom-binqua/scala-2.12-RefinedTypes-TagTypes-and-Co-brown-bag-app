...
//    ....
//    val x: Int = m()  // ... but this x is different. Its meaning depends on other things, maybe on its history for example (not in this case but in case of mutable object yes)
//
//    try {
//      val y = x + x
//    } catch {
